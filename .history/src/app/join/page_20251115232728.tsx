...
export default function JoinPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      memberFormData.append("profileImageUrl", secure_url);

      const registerRes = await fetch("/api/members/register", {
        method: "POST",
        body: memberFormData,
      });

      const { memberId } = await registerRes.json();
